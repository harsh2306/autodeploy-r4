...
/******/ }({
  ...
  !*** ./node_modules/@babel/runtime/node_modules/regenerator-runtime/runtime.js ***!
  \*********************************************************************************/ /*! all exports used */ /***/ function(module, exports1, __webpack_require__) {
        /**
 ...
 */ // eslint-disable-next-line  max-statements
  ...
  !*** ./node_modules/cross-fetch/dist/browser-ponyfill.js ***!
  \***********************************************************/ /*! all exports used */ /***/ function(module, exports2) {
        ...
        exports2 = ctx.fetch // To enable: import fetch from 'cross-fetch'
        ;
        exports2.default = ctx.fetch // For TypeScript consumers without esModuleInterop.
        ;
        exports2.fetch = ctx.fetch // To enable: import {fetch} from 'cross-fetch'
        ;
 ...
 */ function setup(env) {
  ...
  */ function coerce(val) {
  ...
  !*** ./node_modules/regenerator-runtime/runtime.js ***!
  \*****************************************************/ /*! all exports used */ /***/ function(module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function(global1) {
            !function(global) {
                var Op = Object.prototype;
                var hasOwn = Op.hasOwnProperty;
                var undefined; // More compressible than void 0.
                ...
                function AsyncIterator(generator) {
                    function invoke(method, arg, resolve, reject) {
                        ...
                        if (record.type === "throw") reject(record.arg);
                            ...
                            if (value3 && typeof value3 === "object" && hasOwn.call(value3, "__await")) return Promise.resolve(value3.__await).then(function(value) {
                                invoke("next", value, resolve, reject);
                            }, function(err) {
                                invoke("throw", err, resolve, reject);
                            });
                            return Promise.resolve(value3).then(function(unwrapped) {
                                // When a yielded Promise is resolved, its final value becomes
                                // the .value of the Promise<{value,done}> result for the
                ...
                runtime.keys = function(object) {
                    var keys = [];
                    for(var key3 in object)keys.push(key3);
                    keys.reverse();
                    // Rather than returning an object with a next method, we keep
                    // things simple and return the next function itself.
                    return function next() {
            ...
            typeof global1 === "object" ? global1 : typeof window === "object" ? window : typeof self === "object" ? self : this);
        /* WEBPACK VAR INJECTION */ }).call(this, __webpack_require__(/*! ./../webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js"));
    /***/ },
  ...
  \***********************/ /*! all exports used */ /***/ function(module, exports, __webpack_require__) {
        ...
        // @ts-ignore
        var _ref = typeof FHIRCLIENT_PURE !== "undefined" ? window : __webpack_require__(/*! cross-fetch */ "./node_modules/cross-fetch/dist/browser-ponyfill.js"), Response = _ref.Response; // $lab:coverage:on$
 ...
 */ function resolveRef(obj, path, graph, cache, client, signal) {
            ...
            if (node) {
                ...
                return Promise.all(lib_1.makeArray(node).filter(Boolean).map(function(item, i) {
                    ...
                    if (ref) return getRef(ref, cache, client, signal).then(function(sub) {
                        if (graph) {
                            if (isArray) {
                                if (path.indexOf("..") > -1) lib_1.setPath(obj, "" + path.replace("..", "." + i + "."), sub);
                                else lib_1.setPath(obj, path + "." + i, sub);
                            } else lib_1.setPath(obj, path, sub);
                        }
                    }).catch(function(ex) {
 ...
 */ var Client1 = /*#__PURE__*/ function() {
     ...
     */ this.units = lib_1.units;
                ...
                this.patient = {
                    ...
                    request: function request(requestOptions, fhirOptions) {
                        if (fhirOptions === void 0) fhirOptions = {};
                        if (_this.patient.id) return (0, _asyncToGenerator2.default)(/*#__PURE__*/ _regenerator.default.mark(function _callee() {
                            var options;
            ...
            _proto.connect = function connect(fhirJs) {
                if (typeof fhirJs == "function") {
                    ...
                    if (accessToken) options.auth = {
                        ...
                        var _this$state = this.state, username = _this$state.username, password = _this$state.password;
                    ...
                    if (patientId) this.patient.api = fhirJs(Object.assign({}, options, {
                        patient: patientId
                    }));
                }
                return this;
   ...
   */ ;
            _proto.getAuthorizationHeader = function getAuthorizationHeader() {
                ...
                var _this$state2 = this.state, username = _this$state2.username, password = _this$state2.password;
   ...
   * associated storage.
   */ ;
            _proto._clearState = /*#__PURE__*/ function() {
   ...
   */ ;
            _proto.request = /*#__PURE__*/ function() {
                var _request = (0, _asyncToGenerator2.default)(/*#__PURE__*/ _regenerator.default.mark(function _callee7(requestOptions1, fhirOptions, _resolvedRefs) {
                    var _this2 = this;
                    ...
                    return _regenerator.default.wrap(function _callee7$(_context7) {
                        while(true)switch(_context7.prev = _context7.next){
                            case 0:
                                if (fhirOptions === void 0) fhirOptions = {};
                                if (_resolvedRefs === void 0) _resolvedRefs = {};
                                debugRequest = lib_1.debug.extend("client:request");
                                lib_1.assert(requestOptions1, "request requires an url or request options as argument"); // url -----------------------------------------------------------------
                                if (typeof requestOptions1 == "string" || requestOptions1 instanceof URL) {
                                    url = String(requestOptions1);
                                    requestOptions1 = {};
                                } else url = String(requestOptions1.url);
                                ...
                                signal = requestOptions1.signal || undefined; // Refresh the access token if needed
                                job = options.useRefreshToken ? this.refreshIfNeeded({
                                    signal: signal
                                }).then(function() {
                                    return requestOptions1;
                                }) : Promise.resolve(requestOptions1);
                                ...
                                then(function(requestOptions) {
                                    ...
                                    if (authHeader) requestOptions.headers = Object.assign({}, requestOptions.headers, {
                                ...
                                .catch(function(error) {
                                            ...
                                            return _regenerator.default.wrap(function _callee6$(_context6) {
                                                while(true)switch(_context6.prev = _context6.next){
                                                    case 0:
                                                        ...
                                                        links = _data.link || [];
                                                        if (options.flat) _data = (_data.entry || []).map(function(entry) {
                                    ...
                                    .then(function(_data) {
                                        ...
                                        if (requestOptions1.includeResponse) return {
                                            body: _data,
                                            response: response
                                        };
                                        return _data;
   ...
   */ ;
            _proto.refresh = function refresh(requestOptions) {
                ...
                var refreshToken = (_b1 = (_a1 = this.state) === null || _a1 === void 0 ? void 0 : _a1.tokenResponse) === null || _b1 === void 0 ? void 0 : _b1.refresh_token;
                ...
                if (!this._refreshTask) {
                    ...
                    if (!("authorization" in refreshRequestOptions.headers)) {
                        var _this$state3 = this.state, clientSecret = _this$state3.clientSecret, clientId = _this$state3.clientId;
                    ...
                    this._refreshTask = lib_1.request(tokenUri, refreshRequestOptions).then(function(data) {
                        ...
                        if (key) _this3.environment.getStorage().set(key, _this3.state);
  ...
  \**************************/ /*! all exports used */ /***/ function(module, exports, __webpack_require__) {
        ...
        var HttpError1 = /*#__PURE__*/ function(_Error) {
  ...
  \****************************************/ /*! all exports used */ /***/ function(module, exports, __webpack_require__) {
        ...
        /**
 * Browser Adapter
 */ var BrowserAdapter1 = /*#__PURE__*/ function() {
            /**
   ...
   */ ;
            _proto.getSmartApi = function getSmartApi() {
                ...
                return {
                    ready: function ready() {
                        for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++)args[_key] = arguments[_key];
                        return smart_1.ready.apply(smart_1, [
                            _this
                        ].concat(args));
                    },
        ...
        exports.default = BrowserAdapter1;
    /***/ },
  ...
  \******************************/ /*! all exports used */ /***/ function(module, exports, __webpack_require__) {
        ...
        var _adapter$getSmartApi = adapter.getSmartApi(), ready = _adapter$getSmartApi.ready, authorize = _adapter$getSmartApi.authorize, init = _adapter$getSmartApi.init, client = _adapter$getSmartApi.client, options = _adapter$getSmartApi.options; // We have two kinds of browser builds - "pure" for new browsers and "legacy"
 ...
 */ var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "./node_modules/@babel/runtime/helpers/interopRequireDefault.js");
        ...
        // @ts-ignore
        var _ref = typeof FHIRCLIENT_PURE !== "undefined" ? window : __webpack_require__(/*! cross-fetch */ "./node_modules/cross-fetch/dist/browser-ponyfill.js"), fetch = _ref.fetch; // $lab:coverage:on$
 ...
 */ exports.units = {
            cm: function cm(_ref2) {
                var code = _ref2.code, value = _ref2.value;
                ensureNumerical({
                    code: code,
                    value: value
                });
            ...
            kg: function kg(_ref3) {
                var code = _ref3.code, value = _ref3.value;
                ensureNumerical({
                    code: code,
                    value: value
                });
 ...
 */ function ensureNumerical(_ref4) {
            var value = _ref4.value, code = _ref4.code;
 ...
 */ function request(url, requestOptions) {
            if (requestOptions === void 0) requestOptions = {};
            var _requestOptions = requestOptions, includeResponse = _requestOptions.includeResponse, options = (0, _objectWithoutPropertiesLoose2.default)(_requestOptions, [
                "includeResponse"
            ]);
            return fetch(url, Object.assign({
                ...
                if (type.match(/\bjson\b/i)) return responseToJSON(res).then(function(body) {
                    return {
                        res: res,
                        body: body
                    };
                });
                if (type.match(/^text\//i)) return res.text().then(function(body) {
                    return {
                        res: res,
                        body: body
                    };
 ...
 */ function getPath(obj, path) {
            ...
            while(result && segments.length){
                ...
                if (!key && Array.isArray(result)) return result.map(function(o) {
 ...
 */ function setPath(obj, path, value, createEmpty) {
            if (createEmpty === void 0) createEmpty = false;
 ...
 */ function byCode(observations, property) {
            ...
            function handleCodeableConcept(concept, observation) {
                if (concept && Array.isArray(concept.coding)) concept.coding.forEach(function(_ref6) {
                    var code = _ref6.code;
                    if (code) {
                        ret[code] = ret[code] || [];
            ...
            makeArray(observations).forEach(function(o) {
                if (o.resourceType === "Observation" && o[property]) {
                    if (Array.isArray(o[property])) o[property].forEach(function(concept) {
 ...
 */ function byCodes(observations, property) {
            ...
            return function() {
                for(var _len = arguments.length, codes = new Array(_len), _key = 0; _key < _len; _key++)codes[_key] = arguments[_key];
                ...
                return _regenerator.default.wrap(function _callee2$(_context2) {
                    while(true)switch(_context2.prev = _context2.next){
                        ...
                        case 34:
                            ...
                            _context2.prev = 36;
                            _targetWindow = window.open("", "SMARTAuthPopup", [
                                "height=" + height,
                                "width=" + width,
                                "menubar=0",
                                "resizable=1",
 ...
 */ exports.SMART_KEY = "SMART_KEY";
  ...
  \**********************/ /*! all exports used */ /***/ function(module, exports, __webpack_require__) {
        ...
        /* global window */ var lib_1 = __webpack_require__(/*! ./lib */ "./src/lib.ts");
        var Client_1 = __webpack_require__(/*! ./Client */ "./src/Client.ts");
        var settings_1 = __webpack_require__(/*! ./settings */ "./src/settings.ts");
 ...
 */ function any(tasks) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                function onError(error) {
                    if (errors.push(error) === len) reject(new Error(errors.map(function(e) {
                        return e.message;
                    }).join("; ")));
                }
                tasks.forEach(function(t) {
                    ...
                    while(true)switch(_context.prev = _context.next){
                        ...
                        case 70:
                            ...
                            if (win !== self) try {
                                ...
                                lib_1.debug("Failed to modify window.location. Perhaps it is from different origin?. Failing back to \"_self\". %s", ex1);
 ...
 */ function buildTokenRequest(env, code, state) {
            var redirectUri = state.redirectUri, clientSecret = state.clientSecret, tokenUri = state.tokenUri, clientId = state.clientId;
 ...
 */ function init(_x7, _x8) {
  ...
  \***************************************/ /*! all exports used */ /***/ function(module, exports, __webpack_require__) {
        ...
        var Storage1 = /*#__PURE__*/ function() {
            function Storage() {}
